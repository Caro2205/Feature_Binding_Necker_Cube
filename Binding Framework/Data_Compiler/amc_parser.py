...
import sys
sys.path.append('//wsl$/Ubuntu-18.04/home/kaltenfra/BAPTAT/repro/BPAT_continue_01') 
# sys.path.append('~/Documents/BPAT/Code/repro_continue01/BPAT_continue_01') 
...
def test_all(user_asf_path, user_amc_path, user_input_frames, user_input_features, num_selected_features):
  ...
  ################################################
  # adaptation by Franziska Kaltenberger
  ################################################
